...
public class SwipeDetection : MonoBehaviour
{
    ...
    private void SwipeStart(Vector2 position, float time)
    {
        ...
        _trail.transform.position = _Utils.ScreenToWorld(Camera.main, position);
    ...
    private IEnumerator Trail()
    {
        while (true)
        {
            _trail.transform.position = Utils.ScreenToWorld(Camera.main, inputManager.PrimaryPosition());
            yield return null;
        }
    }
