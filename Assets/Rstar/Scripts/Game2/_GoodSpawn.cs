...
public class _GoodSpawn : MonoBehaviour
{
    ...
    [SerializeField] private _ThrowGoodsBossController throwGoodsBossController;
    ...
    public void spawnGoods()
    {
        ...
        good.GetComponent<_GoodsMovement>().StartMove(inputAngle, Speed(inputAngle), gravity);
    }
